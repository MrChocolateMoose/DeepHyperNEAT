    ...
    public class Substrate
    {
        ...
        public INetworkDefinition CreateNetworkDefinition(IBlackBox blackbox, bool lengthCppnInput)
        {
            ...
            foreach(SubstrateConnection substrateConn in connectionSequence)
            {
                ...
                {
                    double srcDimensionalPosition = substrateConn._srcNode._position[i];
                    double trgtDimensionalPosition = substrateConn._tgtNode._position[i];

                    inputSignalArr[i] = srcDimensionalPosition;
                    inputSignalArr[i + _dimensionality] = trgtDimensionalPosition;
                }
