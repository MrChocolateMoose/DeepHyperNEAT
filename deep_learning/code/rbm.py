    ...
    def __init__(self, input=None, n_visible=784, n_hidden=500,
        ...
        if W is None:
            ...
            initial_W = numpy.asarray(numpy_rng.uniform(
                      low=0.01, #4 * numpy.sqrt(6. / (n_hidden + n_visible)),
                      high=0.01, #4 * numpy.sqrt(6. / (n_hidden + n_visible)),
...
def test_rbm(learning_rate=0.1, training_epochs=15,
    ...
    for epoch in xrange(training_epochs):
        ...
        visualized_hbias = rbm.hbias.get_value()
        visualized_hbias = numpy.reshape(visualized_hbias, (25,20))

        subplot(training_epochs,1,epoch)
        imshow(visualized_hbias)
